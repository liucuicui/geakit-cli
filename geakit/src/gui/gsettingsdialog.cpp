...
QString GSettingsDialog::accountUsername()
{
  return ui->usernameEdit->text();
}

QString GSettingsDialog::accountPassword()
{
  return ui->passwordEdit->text();
}

void GSettingsDialog::accountSetUsername(QString username){
  ui->usernameEdit->setText(username);
}

void GSettingsDialog::accountSetPassword(QString password){
